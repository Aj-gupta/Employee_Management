...
<div class="container">
    <div class="row justify-content-center"> 
        <div class="col-12 col-md-6">
			<form action="AddEmployeeLeave" method="post">
				<input type="number" class="form-control" placeholder="Token" name="token" required>
				...
				<input type="number" class="form-control" placeholder="total Days" name="totalDays">
				<input type="text" class="form-control" placeholder="Reason" name="reason" required>
				<input class="btn btn-outline-success" type="submit" name="button" value="Add Leave">
			</form>
				<%
